...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ".exe"
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "C:/Users/shoota/mkxp-z-dev/mkxp-z-dev/windows/build-mingw64")
  ...
  CONFIG["configure_args"] = " '--prefix=/c/Users/shoota/mkxp-z-dev/mkxp-z-dev/windows/build-mingw64' '--prefix=C:/Users/shoota/mkxp-z-dev/mkxp-z-dev/windows/build-mingw64' '--enable-install-static-library' '--disable-install-doc' '--without-ext=openssl,readline,dbm,gdbm,win32ole' '--with-static-linked-ext' '--disable-rubygems' '--without-gmp' 'CC=gcc' 'CFLAGS=-std=gnu99 -flto -I/c/Users/shoota/mkxp-z-dev/mkxp-z-dev/windows/build-mingw64/include -O3' 'LDFLAGS=-flto -L/c/Users/shoota/mkxp-z-dev/mkxp-z-dev/windows/build-mingw64/lib'"
  ...
  CONFIG["DLDFLAGS"] = "-flto -L/c/Users/shoota/mkxp-z-dev/mkxp-z-dev/windows/build-mingw64/lib -Wl,--enable-auto-image-base,--enable-auto-import"
  CONFIG["ALLOCA"] = ""
  CONFIG["dsymutil"] = ""
  CONFIG["codesign"] = ""
  CONFIG["cleanlibs"] = ""
  ...
  CONFIG["LDFLAGS"] = "-L. -flto -L/c/Users/shoota/mkxp-z-dev/mkxp-z-dev/windows/build-mingw64/lib -Wl,--no-as-needed"
  CONFIG["CFLAGS"] = "-std=gnu99 -flto -I/c/Users/shoota/mkxp-z-dev/mkxp-z-dev/windows/build-mingw64/include -O3"
