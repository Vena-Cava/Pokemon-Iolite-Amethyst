...
def pbMessageDisplay(msgwindow, message, letterbyletter = true, commandProc = nil)
  ...
  text.gsub!(/\\pg/i,  "\\g") if $player&.nb?
  text.gsub!(/\\pog/i, "\\r") if $player&.male?
  text.gsub!(/\\pog/i, "\\b") if $player&.female?
  text.gsub!(/\\psg/i, "\\g") if $player&.male?
  text.gsub!(/\\psg/i, "\\b") if $player&.female?
  text.gsub!(/\\psg/i, "\\r") if $player&.nb?
  text.gsub!(/\\pwg/i, "\\r") if $player&.male?
  text.gsub!(/\\pwg/i, "\\g") if $player&.female?
  text.gsub!(/\\pwg/i, "\\b") if $player&.nb?
  text.gsub!(/\\pg/i,  "")
  text.gsub!(/\\pog/i, "")
