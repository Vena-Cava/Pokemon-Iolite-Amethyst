...
module Effectiveness
  ...
  def mostly_ineffective_type?(attack_type, *defend_types)
    value = calculate(attack_type, *defend_types)
    return mostly_ineffective?(value)
  end
  
  def extremely_effective_type?(attack_type, *defend_types)
    value = calculate(attack_type, *defend_types)
    return extremely_effective?(value)
  end
