module GameData
  class Species
    ...
    attr_reader :real_iopokedex_entry
    attr_reader :real_ampokedex_entry
    attr_reader :real_iopokedexus_entry
    attr_reader :real_ampokedexus_entry
    ...
    def self.schema(compiling_forms = false)
      ...
      ret["HatchCycles"]      = [:hatch_cycles,       "v"]
      if compiling_forms
      ...
      ret["IoPokedex"]        = [:real_iopokedex_entry, "q"]
      ret["AmPokedex"]        = [:real_ampokedex_entry, "q"]
      ret["IoPokedexUS"]      = [:real_iopokedexus_entry, "q"]
      ret["AmPokedexUS"]      = [:real_ampokedexus_entry, "q"]
    ...
    def self.editor_properties
      return [
        ...
        ["HatchCycles",       LimitProperty.new(99_999),          _INTL("Number of Egg Cycles until an egg of this species hatches.")],
    ...
    def initialize(hash)
      ...
      @real_iopokedex_entry = hash[:real_iopokedex_entry] || "???"
      @real_ampokedex_entry = hash[:real_ampokedex_entry] || "???"
      @real_iopokedexus_entry = hash[:real_iopokedexus_entry] || @real_iopokedex_entry
      @real_ampokedexus_entry = hash[:real_ampokedexus_entry] || @real_ampokedex_entry
      ...
      @hatch_cycles       = hash[:hatch_cycles]       || 1
    ...
    # @return [String] the translated Iolite Pokédex entry of this species
    def iopokedex_entry
      return pbGetMessageFromHash(MessageTypes::IOPOKEDEX_ENTRIES, @real_iopokedex_entry)
    end
    
    # @return [String] the translated Amethyst Pokédex entry of this species
    def ampokedex_entry
      return pbGetMessageFromHash(MessageTypes::AMPOKEDEX_ENTRIES, @real_ampokedex_entry)
    end
    
    # @return [String] the translated Iolite Pokédex entry of this species if the User is in the United States
    def iopokedexus_entry
      return pbGetMessageFromHash(MessageTypes::IOPOKEDEXUS_ENTRIES, @real_iopokedexus_entry)
    end
    
    # @return [String] the translated Amethyst Pokédex entry of this species if the User is in the United States
    def ampokedexus_entry
      return pbGetMessageFromHash(MessageTypes::AMPOKEDEXUS_ENTRIES, @real_ampokedexus_entry)
    end
