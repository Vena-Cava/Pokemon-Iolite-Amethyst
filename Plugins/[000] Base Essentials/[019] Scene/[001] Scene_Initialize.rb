class Battle::Scene
  ...
  def pbInitSprites
    ...
    if IASummary::IAVERSION == 1 # Is Pokémon Amethyst
        messageBox = pbAddSprite("messageBox", 0, Graphics.height - 96,
                             "Graphics/UI/Battle/overlay_message_am", @viewport)
	  elsif IASummary::IAVERSION == 2 # Is Pokémon Iolite
	    messageBox = pbAddSprite("messageBox", 0, Graphics.height - 96,
                             "Graphics/UI/Battle/overlay_message_io", @viewport)
	  end
    messageBox.z = 195
  ...
  def pbCreateBackdropSprites
    ...
    if time
      ...
      if IASummary::IAVERSION == 1 # Is Pokémon Amethyst
        if pbResolveBitmap(sprintf("Graphics/Battlebacks/battle_message_am"))
          messageFilename = trialName
        end
      elsif IASummary::IAVERSION == 2 # Is Pokémon Iolite
        if pbResolveBitmap(sprintf("Graphics/Battlebacks/battle_message_io"))
          messageFilename = trialName
        end
      end
    end
    ...
    if IASummary::IAVERSION == 1 # Is Pokémon Amethyst
      messageBG  = "Graphics/Battlebacks/battle_message_am"
	  elsif IASummary::IAVERSION == 2 # Is Pokémon Iolite
	    messageBG  = "Graphics/Battlebacks/battle_message_io"
	  end
    # Apply graphics
