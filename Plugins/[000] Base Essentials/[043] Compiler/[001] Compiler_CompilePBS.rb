module Compiler
  ...
  def validate_all_compiled_abilities
    ...
    MessageTypes.setMessagesAsHash(MessageTypes::ABILITY_SHORT_DESCRIPTIONS, ability_short_descriptions)
  end
  ...
  def validate_all_compiled_pokemon
    ...
    species_iopokedex_entries = []
    species_ampokedex_entries = []
    species_iopokedexus_entries = []
    species_ampokedexus_entries = []
    GameData::Species.each do |species|
      ...
      species_iopokedex_entries.push(species.real_iopokedex_entry)
      species_ampokedex_entries.push(species.real_ampokedex_entry)
      species_iopokedexus_entries.push(species.real_iopokedexus_entry)
      species_ampokedexus_entries.push(species.real_ampokedexus_entry)
    end
    ...
    MessageTypes.setMessagesAsHash(MessageTypes::IOPOKEDEX_ENTRIES, species_iopokedex_entries)
    MessageTypes.setMessagesAsHash(MessageTypes::AMPOKEDEX_ENTRIES, species_ampokedex_entries)
    MessageTypes.setMessagesAsHash(MessageTypes::IOPOKEDEXUS_ENTRIES, species_iopokedexus_entries)
    MessageTypes.setMessagesAsHash(MessageTypes::AMPOKEDEXUS_ENTRIES, species_ampokedexus_entries)
  end
  ...
  def validate_compiled_pokemon_form(hash)
    ...
    [:real_name, :real_category, :real_pokedex_entry, :real_iopokedex_entry, :real_ampokedex_entry, :real_iopokedexus_entry, :real_ampokedexus_entry, :base_exp, :growth_rate,
     :gender_ratio, :catch_rate, :happiness, :hatch_steps, :hatch_cycles, :incense, :height,
  ...
  def validate_all_compiled_pokemon_forms
    ...
    MessageTypes.addMessagesAsHash(MessageTypes::IOPOKEDEX_ENTRIES, species_iopokedex_entries)
    MessageTypes.addMessagesAsHash(MessageTypes::AMPOKEDEX_ENTRIES, species_ampokedex_entries)
    MessageTypes.addMessagesAsHash(MessageTypes::IOPOKEDEXUS_ENTRIES, species_iopokedexus_entries)
    MessageTypes.addMessagesAsHash(MessageTypes::AMPOKEDEXUS_ENTRIES, species_ampokedexus_entries)
  end
