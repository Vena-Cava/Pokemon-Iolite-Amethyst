...
#    pbSetSmallFont(@hpNumbers.bitmap)
	...
	@hpBar.mirror = !onPlayerSide  # Flip the HP bar if onPlayerSide is false
    @sprites["hpBar"] = @hpBar
  ...
  def refresh_hp
	...
	# Flip the bar width based on the player's side
    if !onPlayerSide
      @hpBar.src_rect.set(@hpBarBitmap.width - w, 0, w, @hpBar.src_rect.height)  # Flip horizontally
    else
      @hpBar.src_rect.set(0, 0, w, @hpBar.src_rect.height)  # Normal direction
    end
